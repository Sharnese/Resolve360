    ...
    <div className="min-h-screen bg-[#FAF6EC]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div>
            {isInvestigation && (
              <section className="bg-white rounded-2xl border border-[#C0C0C0]/40 p-6 sticky top-20">
                ...
                {contacts.length === 0 ? <p className="text-sm text-black/60">None added by client yet.</p> : (
